    ...
    Rectangle {
        ...
        Rectangle{
            ...
            anchors{
                right: parent.right
                rightMargin: 10
                verticalCenter: feedbackFormTitleRect.verticalCenter
            }
        ...
        Image{
            ...
            MouseArea{
                ...
                onEntered: {
                    ...
                    feedbackTooltip1.visible = !feedbackTooltip1.visible
                }
                onExited:{
        ...
        Rectangle {
            ...
            anchors{
                ...
                leftMargin: 25
                verticalCenter: parent.verticalCenter
//                left: feedbackFormTitleRect.horizontalCenter
//                top: feedbackFormTitleRect.verticalCenter
            }
...
//            height: Math.floor(parent.height* .95)
            ...
            placeholderText: "Type message to developers...."
