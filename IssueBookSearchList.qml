...
//            topMargin: 10
            right: parent.right
            rightMargin: 10
            verticalCenter: issueBookTitleRect.verticalCenter
        }
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            TextInput {
                ...
                onTextChanged: {
                    issueBooksListView.model = function(index) {
                        var book = issueBooksListView.model.get(index);
                        return book.title.toLowerCase().includes(issueBooksSearchBox.text.toLowerCase());
                    };
                }
            }
        }
